...
if ($EXISTING_APP_ID) {
    Write-Host "✓ App registration '$script:APP_NAME' already exists (ID: $EXISTING_APP_ID)" -ForegroundColor Green
    ...
    Write-Host "✓ Created app registration: $script:APP_ID`n" -ForegroundColor Green
}
