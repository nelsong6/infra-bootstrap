...
- **my-homepage**, **kill-me**, **bender-world**, **eight-queens**, **plant-agent**, **fuzzy-tiers-showcase** — app repos that consume shared infra
...
- **2026-04-02** — Added `fuzzy-tiers-showcase` to the app module `for_each` list. Interactive web demo of fzh (fuzzy hierarchical finder) running the actual Go scoring engine via WASM in the browser. Frontend-only, no auth. Will be deployed as Azure Static Web App at `fzh.romaine.life`.
